...
exports.list = exports.todoList = void 0;
...
exports.todoList = conf.get('todo-list');
var ChalkColor;
(function (ChalkColor) {
...
function list() {
    if (exports.todoList && exports.todoList.length && exports.todoList !== null) {
        // Tasks present
        console.log(chalk_1.default[chalkYellow]('Task in green are done. Tasks in red are not done'));
        exports.todoList.forEach(function (task, index) {
            if (task.done) {
